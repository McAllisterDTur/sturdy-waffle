	...
	<ul id="jMenu">
		...
		<li><a class="fNiv" href="tutorial/all.do"><spring:message
				...
				<ul>
					...
					<li><a href="tutorial/sponsor.do"><spring:message
								code="master.page.sponsor.tutorial" /></a></li>
				</ul>
		...
		<security:authorize access="hasRole('SPONSOR')">
			<li><a class="fNiv"><spring:message
				...
				<ul>
					<li class="arrow"></li>
					<li><a href="sponsorship/new.do"><spring:message
								code="master.page.sponsor.newSponsorship" /></a></li>
					<li><a href="sponsorship/mySponsorships.do"><spring:message
