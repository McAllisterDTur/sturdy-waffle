...
<form:form action="finder/finder.do" modelAttribute="finder">
	...
	<form:label path="category"><spring:message code="finder.category"/>:&nbsp;</form:label>
...
<display:table name="finder.fixUpTask" id="row" pagesize="5" requestURI="${requestURI}">
	
	<display:column property="ticker" titleKey="finder.fixuptask.ticker"/>
	<display:column property="category.name" titleKey="finder.fixuptask.category" />

	<display:column property="periodStart" titleKey="finder.fixuptask.periodStart"  />

	<display:column property="periodStart" titleKey="finder.fixuptask.periodStart" />

	<display:column property="maxPrice" titleKey="finder.fixuptask.maxPrice" />
