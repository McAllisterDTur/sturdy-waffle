...
<spring:message code='phase.title' var="titlePH"/>
<spring:message code='phase.description' var="descriptionPH"/>
<spring:message code='phase.ph.date' var="datePH"/>
...
<form:form modelAttribute="phase" action="phase/handyworker/save.do">
	...
	<form:input path="title" placeholder="${ titlePH}"/>
	...
	<form:input path="description" placeholder="${ descriptionPH}"/>
	...
	<form:input path="startTime" placeholder="${ datePH}"/>
	...
	<form:input path="endTime" placeholder="${ datePH}"/>
