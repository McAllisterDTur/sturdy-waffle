...
public class ApplicationService {
	...
	public Application save(final Application application) {
		...
		if (application.getId() == 0) {//creacci�n port parte del handyWorker
		...
		} else {//Actualizacion del status por parte del customer due�o de la fixUpTask o del worker dueño de la application
			...
			Assert.isTrue(application.getFixUpTask().getCustomer().getAccount().equals(this.account) || application.getHandyWorker().getAccount().equals(this.account));//customer loggeado due�o de la task
